...
namespace Services
{
    ...
    public static partial class ADBService
    {
        ...
        public static void updateInitRc(POCO.Models.DeviceModel tempDevice, string generateUser, string deviceId)
        {
            ...
            string initRCversion = "";
            string sdk = getProp("ro.build.version.sdk", deviceId);
            switch (sdk)
            {
                case "30":
                    initRCversion = "lineage18";
                    break;
                case "33":
            ...
            var originalInitRcPath = Path.Combine(exePath, $"Resources/init.{initRCversion}.rc");
