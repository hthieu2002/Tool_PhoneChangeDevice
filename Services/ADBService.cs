...
namespace Services
{
                 ...
                 string[] androidPaths = new string[]
 {
        ...
        {
            runCMDRoot(string.Format("shell \"find ./system/{1}/{0} -exec touch -m -a {{}} +\"", appName, prefix), deviceId);
        ...
        public static void cleanGMSPackagesAndAccounts(string deviceId, bool isRootAndRemount = false)
        {
            if (isRootAndRemount)
            {
                ADBService.runCMDRoot("root", deviceId, 0);
                ADBService.runCMDRoot("remount", deviceId, 0);
            }
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/data/*/"), deviceId, 0);
            //runCMDRoot(String.Format("shell \"rm -rf {0} \"", "/data/user/*/*/*"), deviceId);
            //runCMDRoot(String.Format("shell \"rm -rf {0} \"", "/data/user_de/*/"), deviceId);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.chrome"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.vending"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.providers.contacts"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.htmlviewer"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.location.fused"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.providers.media"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.providers.downloads"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.providers.downloads.ui"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.android.webview"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.webview"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.gsf"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.ims"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.gm"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.calendar"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.play.games"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.gsf.login"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.youtube"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.apps.magazines"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.apps.docs"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.configupdater"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.onetimeinitializer"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.setupwizard"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.tts"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.apps.restore"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.backuptransport"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.carriersetup"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.ext.services"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.feedback"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.partnersetup"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.syncadapters.calendar"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.syncadapters.contacts"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell pm clear {0}", "com.google.android.gms"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/*.db*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/sync/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/slice/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/graphicsstats/*/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/package_cache/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/device_config/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/deviceidle/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/storage/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/stats-service/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/users/*/settings_ssaid.xml*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/users/*/package-restrictions.xml*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/users/*/registered_services/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/dropbox/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/syncmanager-log/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/usagestats/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/recoverablekeystore.db*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system/job/jobs.xml"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_ce/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/*.db*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/LocalesFromDelegatePrefs.xml"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/persisted_taskIds.txt"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/apprestriction/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/app_lock/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/powerstats/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/ringtones/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/system_de/*/system/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc/profiles/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc/gatekeeper/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc/logd/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc/update_engine/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc/update_engine_log/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc_de/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/misc_ce/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/vendor/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/vendor_ce/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/vendor_de/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/apex/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/backup/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/cache/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/drm/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/nfc/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/media/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/mediadrm/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/ss/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/ssh/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/server_configurable_flags/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/data/incremental/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/mnt/user/0/self/primary/Android/data/*/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/system/product/app/webview/oat/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "/system/product/app/webview/*/oat/*"), deviceId, 0);
            ADBService.runCMDRoot(string.Format("shell \"rm -rf {0} \"", "./etc/security/otacerts.zip"), deviceId, 0);
            ADBService.updateFileDateTimeModification("./system/priv-app", deviceId);
            ADBService.updateFileDateTimeModification("./system/app", deviceId);
            ADBService.updateFileDateTimeModification("./system/product/priv-app", deviceId);
            ADBService.updateFileDateTimeModification("./system/product/app", deviceId);
            ADBService.updateFileDateTimeModification("./system/system_ext/priv-app", deviceId);
            ADBService.updateFileDateTimeModification("./system/system_ext/app", deviceId);
            ADBService.updateFileDateTimeModification("./system/vendor/app", deviceId);
            ADBService.updateFileDateTimeModification("./product/priv-app", deviceId);
            ADBService.updateFileDateTimeModification("./product/app", deviceId);
            ADBService.updateFileDateTimeModification("./system_ext/priv-app", deviceId);
            ADBService.updateFileDateTimeModification("./system_ext/app", deviceId);
            ADBService.updateFileDateTimeModification("./vendor/app", deviceId);
            ADBService.updateFileDateTimeModification("./data/app", deviceId);
        }
        ...
        {
            string response = runCMDRoot(String.Format("shell ls {0}", path), deviceId);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        public static void FakeLocation(string latitude, string longitude, string deviceId)
        {
            ...
            runCMDRoot($"shell settings put global mi_latitude {latitude}", deviceId);
            runCMDRoot($"shell settings put global mi_longitude {longitude}", deviceId);
        }

        public static void OpenUrl(string url, string deviceId)
        {
            runCMDRoot($"shell am start -a android.intent.action.VIEW -d {url}", deviceId);
        }
        public static void ScreenShotDevice(string device)
        {
            runCMDRoot($"shell screencap -p /sdcard/screen.png", device);
        }
        ...
        {
            var str = runCMDRoot("shell ping -c 4 google.com", deviceId).Replace("\r\n", "");
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        {
            runCMDRoot($"shell am start -a android.settings.WIFI_SETTINGS", deviceId);
        }
        ...
        {
            runCMDRoot(string.Format("shell am start -a android.intent.action.VIEW -d {0}", url), deviceId);
        }
